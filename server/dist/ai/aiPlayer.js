 ...
 */
function calculateBustProbability(player, deck, discardPile) {
    const drawnNumbers = new Set(player.numberCards
 ...
 */
function calculateExpectedValue(player, deck, discardPile) {
 ...
 */
export function makeAIDecision(player, gameState, difficulty = 'moderate') {
    ...
    const currentScore = calculateScore(player);
    const bustProb = calculateBustProbability(player, gameState.deck, gameState.discardPile);
    const expectedValue = calculateExpectedValue(player, gameState.deck, gameState.discardPile);
 ...
 */
function selectActionCardTarget(player, gameState, actionType) {
 ...
 */
function decideActionCardUsage(player, gameState) {
