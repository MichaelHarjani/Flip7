      ...
      <div className="absolute top-4 left-4">
        {!loading && isGuest && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-100 text-gray-800 rounded-lg font-semibold shadow-lg transition-all hover:scale-105"
          >
        ...
        {!loading && !isGuest && user && (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg shadow-lg transition-all border-2 border-gray-600"
            >
              ...
              <span className="font-semibold">{profile?.username || user.user_metadata?.name || user.email}</span>
