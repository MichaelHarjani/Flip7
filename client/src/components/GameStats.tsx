...
export default function GameStats() {
  ...
  return (
    <div className="rounded-lg p-2 border-2 mt-2 text-sm bg-gray-800 border-gray-600">
      <h3 className="text-base font-bold mb-2 text-white">Game Statistics</h3>

      {/* Overall Stats - Compact */}
      <div className="mb-2 p-2 rounded bg-gray-700">
      ...
      <div className="mb-2 p-2 rounded bg-gray-700">
        <div className="text-xs font-semibold mb-1.5 text-gray-300">Per Player</div>
        <div className="space-y-1.5">
          {/* Header Row */}
          <div className="grid grid-cols-3 gap-2 px-1.5 pb-0.5 border-b border-gray-600 text-xs text-gray-400 font-semibold">
            <div>Busts</div>
            <div>Scored</div>
            <div>Avg</div>
          </div>
          ...
          {gameState.players.map(player => {
            ...
            return (
              <div key={player.id} className="px-1.5 py-1 rounded border text-xs bg-gray-800 border-gray-600">
      ...
      {largestRound && (
        <div className="p-2 rounded bg-gray-700">
          <div className="text-xs font-semibold mb-1.5 text-gray-300">Largest Round</div>
          <div className="mb-1.5 p-1.5 rounded bg-gray-800">
              ...
              return (
                <div className="space-y-1">
                  {numberCards.length > 0 && (
                    <div>
                      <div className="text-[10px] mb-0.5 text-gray-400">
                        Numbers:
                      </div>
